...
void loop() {
  ...
  if (distance < _DIST_MIN) {
    ...
    digitalWrite(PIN_LED, 1);       // LED OFF
  } else if (distance <= 200.00) {
    analogWrite(PIN_LED, (distance-100)*(distance-100)*(distance-100) * -255 / 1000000 +255 );  
  } else {    // In desired Range
    analogWrite(PIN_LED,(distance-300)*(distance-300)*(distance-300) * 255 / 1000000 +255 );       // LED ON      
  }
