...
// Servo adjustment
#define _DUTY_MAX 2055  // Servo angle: D degree
#define _DUTY_NEU 1695  // Servo angle: 0 degree
#define _DUTY_MIN 1055   // Servo angle: E degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 538 + -0.962 * x + -4.62 / 1000.0 * x * x + 1.5 / 100000.0 * x * x * x + -1.18 / 100000000.0 * x * x * x * x;
}
